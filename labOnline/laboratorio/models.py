...
class Artigo(models.Model):
	autor = models.OneToOneField(Pessoa, default=2, on_delete=models.CASCADE)
...
class Noticia(models.Model):
    autor = models.OneToOneField(Pessoa, default=1, on_delete = models.CASCADE)
